...
{{-- Fondo institucional oscuro igual al inicio --}}
        ...
        @else
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($autoridades as $a)
                    <article class="group relative rounded-2xl overflow-hidden transition-all duration-300" style="background: rgba(255,255,255,0.08); backdrop-filter: blur(16px);">
                        {{-- Efecto hover sutil --}}
                        ...
                        <div class="relative px-7 py-8">
                            {{-- Cargo institucional con icono académico --}}
                            <div class="mb-6 px-4">
                                <div class="relative flex items-center justify-between py-4 px-5 rounded-2xl transition-all duration-300 group/cargo" style="background: linear-gradient(135deg, rgba(6,182,212,0.35) 0%, rgba(59,130,246,0.35) 50%, rgba(99,102,241,0.30) 100%); border: 2px solid rgba(6,182,212,0.5); box-shadow: 0 8px 25px rgba(6,182,212,0.4);">
                                    
                                    {{-- Icono académico (birrete de graduación) a la izquierda --}}
                                    ...
                                    {{-- Brillo animado --}}
                                    <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-transparent via-cyan-300/20 to-transparent opacity-0 group-hover/cargo:opacity-100 group-hover/cargo:animate-pulse transition-opacity"></div>
                                </div>
                            </div>
                            ...
                            <div class="text-center">
                                {{-- Nombre con check institucional --}}
                                <div class="flex items-center justify-center gap-2 mb-4">
                                    ...
                                    {{-- Badge verificado institucional --}}
                                    <div class="relative flex-shrink-0" title="Autoridad Verificada">
                            ...
                            {{-- Período con entorno decorativo --}}
                                <div class="flex items-center justify-center gap-3 mb-5">
                                    <div class="relative inline-flex items-center gap-2 px-5 py-2.5 rounded-xl" style="background: linear-gradient(135deg, rgba(59,130,246,0.2) 0%, rgba(147,197,253,0.15) 100%); border: 1.5px solid rgba(59,130,246,0.4); box-shadow: 0 4px 15px rgba(59,130,246,0.2);">
                                        {{-- Icono calendario --}}
                                        <svg class="w-4 h-4 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/>
                                        </svg>
                                        <span class="text-white font-bold text-sm tracking-wide">Período 2026-2030</span>
                                        {{-- Icono institucional --}}
                                        <svg class="w-4 h-4 text-blue-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"/>
                                        </svg>
                                        {{-- Brillo interno --}}
                                        <div class="absolute inset-0 rounded-xl bg-gradient-to-r from-transparent via-white/10 to-transparent opacity-50"></div>
                                    </div>
                                </div>
                        </div>
                    </article>
