<x-public-layout><div class="relative overflow-hidden min-h-screen" style="background: linear-gradient(135deg, rgba(15,23,42,0.92) 0%, rgba(30,41,59,0.92) 30%, rgba(30,58,138,0.90) 60%, rgba(15,23,42,0.93) 100%);"><div class="absolute inset-0 pointer-events-none">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20"><div class="mb-16 text-center">
        ...
        </div>@if($destacados->count())
            <div class="mb-16"><div class="flex items-center gap-3 mb-8">
        ...
        @endif@if($pasados->count())
            <div class="mb-16"><div class="flex items-center gap-3 mb-8">
                ...
                </div><div class="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        @endif@if($destacados->isEmpty() && $proximos->isEmpty() && $enCurso->isEmpty() && $pasados->isEmpty())
