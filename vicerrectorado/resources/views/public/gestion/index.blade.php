<x-public-layout><div id="top" class="relative overflow-hidden min-h-screen" style="background: linear-gradient(135deg, rgba(15,23,42,0.92) 0%, rgba(30,41,59,0.92) 30%, rgba(30,58,138,0.90) 60%, rgba(15,23,42,0.93) 100%);"><div class="absolute inset-0 pointer-events-none">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20"><div class="mb-12 text-center">
        ...
        @endif@foreach($documentos as $tipo => $items)
            
            <div id="{{ Str::slug($tipo) }}" class="mb-16 scroll-mt-24"><div class="flex items-center gap-3 mb-8">
                    @php
                        $colorConfig = match(strtolower($tipo)) {
                    ...
                    @foreach($items as $doc)
                        <div class="group relative rounded-2xl overflow-hidden transition-all duration-300 hover:-translate-y-1" style="background: rgba(255,255,255,0.08); backdrop-filter: blur(16px);"><div class="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" style="background: radial-gradient(ellipse at 50% 50%, rgba(59,130,246,0.12) 0%, transparent 75%);"></div>
                            ...
                            <div class="relative p-6"><div class="mb-4 flex items-center justify-between">
                                ...
                                </div><h3 class="text-xl font-bold text-white mb-3 leading-tight">
                                    {{ $doc->titulo }}
                                </h3>@if($doc->fecha_publicacion)
                                ...
                                @endif<p class="text-white/70 text-sm leading-relaxed mb-4">
        ...
        @endforeach@if($documentos->isEmpty())
