<div class="container mx-auto">
    ...
    <div class="bg-white shadow rounded p-6"><div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    @forelse($logs as $log)
                        <tr class="border-b hover:bg-gray-50"><td class="p-3 whitespace-nowrap">
    ...
    </div><div class="grid grid-cols-1 md:grid-cols-4 gap-4 mt-6">
